...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.scalekit.grpc.buf.validate.ValidateProto.internal_static_buf_validate_MessageRules_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.scalekit.grpc.buf.validate.ValidateProto.internal_static_buf_validate_MessageRules_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.scalekit.grpc.buf.validate.MessageRules.class, com.scalekit.grpc.buf.validate.MessageRules.Builder.class);
  }
  ...
  @SuppressWarnings("serial")
  private java.util.List<com.scalekit.grpc.buf.validate.MessageOneofRule> oneof_;
  /**
   * <pre>
   ...
   */
  @java.lang.Override
  public java.util.List<com.scalekit.grpc.buf.validate.MessageOneofRule> getOneofList() {
    return oneof_;
  }
  /**
   * <pre>
   ...
   */
  @java.lang.Override
  public java.util.List<? extends com.scalekit.grpc.buf.validate.MessageOneofRuleOrBuilder> 
   ...
   */
  @java.lang.Override
  public com.scalekit.grpc.buf.validate.MessageOneofRule getOneof(int index) {
   ...
   */
  @java.lang.Override
  public com.scalekit.grpc.buf.validate.MessageOneofRuleOrBuilder getOneofOrBuilder(
      int index) {
    return oneof_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.scalekit.grpc.buf.validate.MessageRules)) {
      return super.equals(obj);
    }
    com.scalekit.grpc.buf.validate.MessageRules other = (com.scalekit.grpc.buf.validate.MessageRules) obj;
  ...
  public static com.scalekit.grpc.buf.validate.MessageRules parseFrom(
  ...
  public static com.scalekit.grpc.buf.validate.MessageRules parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.scalekit.grpc.buf.validate.MessageRules parseFrom(
  ...
  public static com.scalekit.grpc.buf.validate.MessageRules parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.scalekit.grpc.buf.validate.MessageRules parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static com.scalekit.grpc.buf.validate.MessageRules parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.scalekit.grpc.buf.validate.MessageRules prototype) {
  ...
  public static final class Builder extends
      ...
      com.scalekit.grpc.buf.validate.MessageRulesOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.scalekit.grpc.buf.validate.ValidateProto.internal_static_buf_validate_MessageRules_descriptor;
    }
    ...
    // Construct using com.scalekit.grpc.buf.validate.MessageRules.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public com.scalekit.grpc.buf.validate.MessageRules getDefaultInstanceForType() {
      return com.scalekit.grpc.buf.validate.MessageRules.getDefaultInstance();
    }

    @java.lang.Override
    public com.scalekit.grpc.buf.validate.MessageRules build() {
      com.scalekit.grpc.buf.validate.MessageRules result = buildPartial();
    ...
    @java.lang.Override
    public com.scalekit.grpc.buf.validate.MessageRules buildPartial() {
      com.scalekit.grpc.buf.validate.MessageRules result = new com.scalekit.grpc.buf.validate.MessageRules(this);
    ...
    private void buildPartialRepeatedFields(com.scalekit.grpc.buf.validate.MessageRules result) {
      if (celBuilder_ == null) {
    ...
    private void buildPartial0(com.scalekit.grpc.buf.validate.MessageRules result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.scalekit.grpc.buf.validate.MessageRules) {
        return mergeFrom((com.scalekit.grpc.buf.validate.MessageRules)other);
      } else {
    ...
    public Builder mergeFrom(com.scalekit.grpc.buf.validate.MessageRules other) {
      if (other == com.scalekit.grpc.buf.validate.MessageRules.getDefaultInstance()) return this;
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 34: {
              com.scalekit.grpc.buf.validate.MessageOneofRule m =
                  input.readMessage(
                      com.scalekit.grpc.buf.validate.MessageOneofRule.PARSER,
                      extensionRegistry);
              if (oneofBuilder_ == null) {
                ensureOneofIsMutable();
                oneof_.add(m);
    ...
    private void ensureOneofIsMutable() {
      if (!((bitField0_ & 0x00000004) != 0)) {
        oneof_ = new java.util.ArrayList<com.scalekit.grpc.buf.validate.MessageOneofRule>(oneof_);
        bitField0_ |= 0x00000004;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.scalekit.grpc.buf.validate.MessageOneofRule, com.scalekit.grpc.buf.validate.MessageOneofRule.Builder, com.scalekit.grpc.buf.validate.MessageOneofRuleOrBuilder> oneofBuilder_;
    ...
    public Builder setOneof(
        int index, com.scalekit.grpc.buf.validate.MessageOneofRule value) {
      if (oneofBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setOneof(
        int index, com.scalekit.grpc.buf.validate.MessageOneofRule.Builder builderForValue) {
      if (oneofBuilder_ == null) {
        ensureOneofIsMutable();
     ...
     * <code>repeated .buf.validate.MessageOneofRule oneof = 4 [json_name = "oneof"];</code>
     */
    public Builder addOneof(com.scalekit.grpc.buf.validate.MessageOneofRule value) {
      if (oneofBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addOneof(
        com.scalekit.grpc.buf.validate.MessageOneofRule.Builder builderForValue) {
      if (oneofBuilder_ == null) {
        ensureOneofIsMutable();
    ...
    public Builder addAllOneof(
        java.lang.Iterable<? extends com.scalekit.grpc.buf.validate.MessageOneofRule> values) {
      if (oneofBuilder_ == null) {
        ensureOneofIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, oneof_);
     ...
     * <code>repeated .buf.validate.MessageOneofRule oneof = 4 [json_name = "oneof"];</code>
     */
    public com.scalekit.grpc.buf.validate.MessageOneofRule.Builder getOneofBuilder(
        int index) {
     ...
     * <code>repeated .buf.validate.MessageOneofRule oneof = 4 [json_name = "oneof"];</code>
     */
    public com.scalekit.grpc.buf.validate.MessageOneofRule.Builder addOneofBuilder() {
      return getOneofFieldBuilder().addBuilder(
          com.scalekit.grpc.buf.validate.MessageOneofRule.getDefaultInstance());
    }
    /**
     * <pre>
     * `oneof` is a repeated field of type MessageOneofRule that specifies a list of fields
    ...
    public com.scalekit.grpc.buf.validate.MessageOneofRule.Builder addOneofBuilder(
        int index) {
      return getOneofFieldBuilder().addBuilder(
          index, com.scalekit.grpc.buf.validate.MessageOneofRule.getDefaultInstance());
    }
    /**
     * <pre>
     * `oneof` is a repeated field of type MessageOneofRule that specifies a list of fields
     ...
     * <code>repeated .buf.validate.MessageOneofRule oneof = 4 [json_name = "oneof"];</code>
     */
    public java.util.List<com.scalekit.grpc.buf.validate.MessageOneofRule.Builder> 
         getOneofBuilderList() {
      return getOneofFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.scalekit.grpc.buf.validate.MessageOneofRule, com.scalekit.grpc.buf.validate.MessageOneofRule.Builder, com.scalekit.grpc.buf.validate.MessageOneofRuleOrBuilder> 
  ...
  private static final com.scalekit.grpc.buf.validate.MessageRules DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.scalekit.grpc.buf.validate.MessageRules();
  }

  public static com.scalekit.grpc.buf.validate.MessageRules getDefaultInstance() {
