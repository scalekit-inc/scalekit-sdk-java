...
public interface InfoOrBuilder extends
   ...
   * @return The contact.
   */
  com.scalekit.grpc.grpc.gateway.protoc_gen_openapiv2.options.Contact getContact();
  /**
   * <pre>
   * The contact information for the exposed API.
   * </pre>
   ...
   * <code>.grpc.gateway.protoc_gen_openapiv2.options.Contact contact = 4 [json_name = "contact"];</code>
   */
  com.scalekit.grpc.grpc.gateway.protoc_gen_openapiv2.options.ContactOrBuilder getContactOrBuilder();
   ...
   * @return The license.
   */
  com.scalekit.grpc.grpc.gateway.protoc_gen_openapiv2.options.License getLicense();
  /**
   * <pre>
   * The license information for the exposed API.
   * </pre>
   ...
   * <code>.grpc.gateway.protoc_gen_openapiv2.options.License license = 5 [json_name = "license"];</code>
   */
  com.scalekit.grpc.grpc.gateway.protoc_gen_openapiv2.options.LicenseOrBuilder getLicenseOrBuilder();
