...
com.scalekit.grpc.grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme defaultValue) {
  ...
  public static final class Builder extends
    ...
    private static final class SecurityConverter implements com.google.protobuf.MapFieldBuilder.Converter<java.lang.String, com.scalekit.grpc.grpc.gateway.protoc_gen_openapiv2.options.SecuritySchemeOrBuilder, com.scalekit.grpc.grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme> {
      @java.lang.Override
      public com.scalekit.grpc.grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme build(com.scalekit.grpc.grpc.gateway.protoc_gen_openapiv2.options.SecuritySchemeOrBuilder val) {
        if (val instanceof com.scalekit.grpc.grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme) { return (com.scalekit.grpc.grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme) val; }
        return ((com.scalekit.grpc.grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme.Builder) val).build();
      }

      @java.lang.Override
      public com.google.protobuf.MapEntry<java.lang.String, com.scalekit.grpc.grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme> defaultEntry() {
    ...
    private com.google.protobuf.MapFieldBuilder<
        java.lang.String, com.scalekit.grpc.grpc.gateway.protoc_gen_openapiv2.options.SecuritySchemeOrBuilder, com.scalekit.grpc.grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme, com.scalekit.grpc.grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme.Builder> security_;
    private com.google.protobuf.MapFieldBuilder<java.lang.String, com.scalekit.grpc.grpc.gateway.protoc_gen_openapiv2.options.SecuritySchemeOrBuilder, com.scalekit.grpc.grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme, com.scalekit.grpc.grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme.Builder>
        internalGetSecurity() {
      if (security_ == null) {
...
com.scalekit.grpc.grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme defaultValue) {
      if (key == null) { throw new NullPointerException("map key"); }
      java.util.Map<java.lang.String, com.scalekit.grpc.grpc.gateway.protoc_gen_openapiv2.options.SecuritySchemeOrBuilder> map = internalGetMutableSecurity().ensureBuilderMap();
    ...
    public Builder putAllSecurity(
      ...
      for (java.util.Map.Entry<java.lang.String, com.scalekit.grpc.grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme> e : values.entrySet()) {
     ...
     * <code>map&lt;string, .grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme&gt; security = 1 [json_name = "security"];</code>
     */
    public com.scalekit.grpc.grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme.Builder putSecurityBuilderIfAbsent(
        java.lang.String key) {
      java.util.Map<java.lang.String, com.scalekit.grpc.grpc.gateway.protoc_gen_openapiv2.options.SecuritySchemeOrBuilder> builderMap = internalGetMutableSecurity().ensureBuilderMap();
      com.scalekit.grpc.grpc.gateway.protoc_gen_openapiv2.options.SecuritySchemeOrBuilder entry = builderMap.get(key);
      if (entry == null) {
        entry = com.scalekit.grpc.grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme.newBuilder();
        builderMap.put(key, entry);
      }
      if (entry instanceof com.scalekit.grpc.grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme) {
        entry = ((com.scalekit.grpc.grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme) entry).toBuilder();
        builderMap.put(key, entry);
      }
      return (com.scalekit.grpc.grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme.Builder) entry;
    }
    @java.lang.Override
