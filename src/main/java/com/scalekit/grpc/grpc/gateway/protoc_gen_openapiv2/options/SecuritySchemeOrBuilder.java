...
public interface SecuritySchemeOrBuilder extends
   ...
   * @return The type.
   */
  com.scalekit.grpc.grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme.Type getType();
   ...
   * @return The in.
   */
  com.scalekit.grpc.grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme.In getIn();
   ...
   * @return The flow.
   */
  com.scalekit.grpc.grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme.Flow getFlow();
   ...
   * @return The scopes.
   */
  com.scalekit.grpc.grpc.gateway.protoc_gen_openapiv2.options.Scopes getScopes();
  /**
   * <pre>
   * The available scopes for the OAuth2 security scheme.
   * Valid for oauth2.
   ...
   * <code>.grpc.gateway.protoc_gen_openapiv2.options.Scopes scopes = 8 [json_name = "scopes"];</code>
   */
  com.scalekit.grpc.grpc.gateway.protoc_gen_openapiv2.options.ScopesOrBuilder getScopesOrBuilder();
