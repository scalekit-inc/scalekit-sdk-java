...
public interface UpdateMembershipRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:scalekit.v1.users.UpdateMembershipRequest)
   ...
   */
  com.scalekit.grpc.scalekit.v1.users.UpdateMembership getMembership();
  /**
   * <code>.scalekit.v1.users.UpdateMembership membership = 5 [json_name = "membership", (.grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = { ... }</code>
   */
  com.scalekit.grpc.scalekit.v1.users.UpdateMembershipOrBuilder getMembershipOrBuilder();

  com.scalekit.grpc.scalekit.v1.users.UpdateMembershipRequest.IdentitiesCase getIdentitiesCase();
}
